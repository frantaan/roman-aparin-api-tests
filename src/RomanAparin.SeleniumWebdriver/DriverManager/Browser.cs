...
using RomanAparin.SeleniumWebDriver.Exсeptions;
using static RomanAparin.SeleniumWebDriver.DriverManager.DriverFactory;
using static RomanAparin.SeleniumWebDriver.Helpers.DirectoryHelper;

namespace RomanAparin.SeleniumWebDriver.DriverManager
{
    public static class Browser
    {
        ...
        {
            var arguments = args.Select(el => el is Elements.BaseTypes.WebElement ? ((IElement) el).GetNative() : el);
        ...
        public static void SwitchToIFrame(IWebElement element) => GetDriver.SwitchTo().Frame(element);
